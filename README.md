# 🧠 Multimodal RAG System with Multi-Agent Architecture (In Progress)
...
⚠️ This project is currently **in progress** and focuses on architecture design,
...
- Vector Databases (FAISS / Chroma – planned)
...
✔️ Initial RAG pipeline (text-based)  
✔️ Agent role definition  
